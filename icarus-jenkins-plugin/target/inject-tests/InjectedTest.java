...
public class InjectedTest extends junit.framework.TestCase {
  public static junit.framework.Test suite() throws Exception {
    ...
    parameters.put("basedir","/Users/daniel.irwin/git/project-icarus/icarus-jenkins-plugin");
    parameters.put("artifactId","icarus-jenkins-plugin");
    parameters.put("outputDirectory","/Users/daniel.irwin/git/project-icarus/icarus-jenkins-plugin/target/classes");
    parameters.put("testOutputDirectory","/Users/daniel.irwin/git/project-icarus/icarus-jenkins-plugin/target/test-classes");
